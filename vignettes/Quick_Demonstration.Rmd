...
This vignette shows you some examples of using the package's main function, [`create_pal`](https://genchanghsu.github.io/PalCreatoR/reference/create_pal.html). You will learn how to make good use of its functionality to create your own nice palette.   

We will play around with the [`create_pal`](https://genchanghsu.github.io/PalCreatoR/reference/create_pal.html) function using the image below (photo credit: Gen-Chang Hsu). This stonecrop species (*Sedum morrisonense* Hayata) is endemic to Taiwan and commonly seen at mid- and high-altitudes. It thrives in the rock cracks and crevices, growing low and spreading out to avoid strong wind. It is also characterized by its densely-clumped, fingernail-like succulent leaves, which are used for water storage. During summertime, blossoms of bright yellow flowers will burst into bloom.

<img src = "C:/Users/Win7/Desktop/PalCreatoR/inst/Alpine Flower.JPG" align = "center" height = "400" />
...
Another novel feature of the [`create_pal`](https://genchanghsu.github.io/PalCreatoR/reference/create_pal.html) function is that you can specify `method = Gaussian_mix` to apply multivariate Gaussian mixture modeling
...
Not too much difference in this case.
...
Let's apply the palettes to the figure:
```{r, tidy = FALSE }
library(ggplot2)
library(ggpubr)
